...
#     stop(paste("No documentation for ‘",topic," ’ in specified packages and libraries: you could try ‘??",topic,"’. (But not yet on DataCamp, since that's not implemented yet ;-).",sep=""))    
#   }else{
